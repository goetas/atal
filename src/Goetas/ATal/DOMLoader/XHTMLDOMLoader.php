<?php
namespace Goetas\ATal\DOMLoader;
...
class XHTMLDOMLoader extends XMLDOMLoader
{
    ...
    {
        $str = preg_replace_callback("#<(title|iframe|textarea|div|span|p|h1|h2|h3|h4|h5|h6|label|fieldset|legend|strong|small|cite|script|style|select|em|td|b)/>#i", function ($mch)
        {
