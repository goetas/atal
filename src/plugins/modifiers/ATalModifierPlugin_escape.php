<?php
class ATalModifierPlugin_escape extends ATalModifierPlugin {
	...
	public static function escapeValue($value='', $format='xml'){
		switch($format){
			...
			default:
				throw new ATalException('Escape\'s format argument must be one of : xml, htmlall, url, urlpathinfo, hex, hexentity, javascript or mail, "'.$format.'" given.');
